export const API_HOST = "https://atlas-henry-api.herokuapp.com";
/*export const API_HOST = "http://localhost:3000";*/

//images
export const IMAGES_ROUTES = "http://localhost:3000/images/";

//Acciones asociadas a Product
export const GET_PRODUCTS = `${API_HOST}/products`; //						LISTAR PRODUCTOS
export const POST_PRODUCT = `${API_HOST}/products`; //				 		AGREGAR PRODUCTO
export const GET_PRODUCT = `${API_HOST}/products/search`; //:id || ?value		BUSCAR PRODUCTO
export const PUT_PRODUCT = `${API_HOST}/products`; //:id 					MODIFICAR PRODUCTO
...
export const DELETE_PRODUCT = `${API_HOST}/products`; //:id 					ELIMINAR PRODUCTO

//Acciones asociadas a Category
export const GET_CATEGORIES = `${API_HOST}/categories`; //				    LISTAR CATEGORIAS
export const POST_CATEGORY = `${API_HOST}/products/category`; //.body 		    AGREGAR CATEGORIA
export const PUT_CATEGORY = `${API_HOST}/products/category`; //:id & .body 	    MODIFICAR CATEGORIA
export const DELETE_CATEGORY = `${API_HOST}/products/category`; //:id 			    ELIMINAR CATEGORIA
